...
Bootstrap ClassLoader 用户加载 Java 的核心类库，只有这些核心类库加载了，JVM 环境准备好了，才能运行 Java 程序，如果 Bootstrap ClassLoader 用 Java 实现，Bootstrap ClassLoader 运行时 JVM 还没准备好，无法运行 Java 程序，就像一个人无法薅着自己的头发，将自己提起。因此 Bootstrap ClassLoader 必须找一个脱离 JVM 也可以运行的程序实现。所以 Bootstrap ClassLoader 并不继承 java.Lang.ClassLoader。
...
<img src="/images/java/screenshot-20221124-163858.png" style="zoom:33%;" />
...
<img src="/images/java/screenshot-20221124-191345.png" style="zoom:33%;" />
...
<img src="/images/java/screenshot-20221124-192652.png" style="zoom:33%;" />
...
<img src="/images/java/screenshot-20221124-194432.png" style="zoom:33%;" />
...
<img src="/images/java/screenshot-20221124-195130.png" style="zoom:33%;" />
...
<img src="/images/java/screenshot-20221124-192652.png" style="zoom:50%;" />
