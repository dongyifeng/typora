...
import com.infra.rediscluster.sharding.JedisCluster;
import com.search.config.IndexRedisKeys;
import com.search.config.SearchIndexConfiguration;
import com.search.util.SearchIndexUtil;
...
public class TaskLogAspect {
    ...
    @Around("@annotation(com.search.annotation.TaskLock)")
