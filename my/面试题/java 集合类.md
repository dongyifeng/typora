...
# MySQL 索引二叉树，B-树， B+树的区别?聚簇索引二级索引二级索引的主键 id 能不能由数据地址来替代，为什么？





# Kafka数据丢失问题分别从 producer, broker, consumer 来回答以及自己项目中遇到了丢消息的场景， 如何来解决的。kafka 如何保证高可用， 高吞吐kafka 如何保证消息的有序性
